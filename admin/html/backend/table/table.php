        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <a href="add-table.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Table</a>
                </div>
            </div>
            <div class="col-lg-12">
                ...
                <table class="data-table table mb-0 tbl-server-info">
                    ...
                    <tbody class="ligth-body">
                        <?php
                            $no = 1;
                            foreach($tampil as $t) {
                                $status_class = ($t->status == 'telah diisi') ? 'text-danger' : 'text-success';
                                echo "
                                <tr>
                                    <td>$no</td>
                                    <td>$t->no</td>
                                    ...
                                    <div class='d-flex align-items-center list-action'>
                                        <a class='badge bg-success mr-2' data-toggle='tooltip' data-placement='top' title='' data-original-title='Isi'
                                            href='status-table.php?isi=$t->id_meja'><i class='ri-check-line mr-0'></i></a>
                                        <a class='badge bg-danger mr-2' data-toggle='tooltip' data-placement='top' title='' data-original-title='Kosongkan'
                                            href='status-table.php?kosong=$t->id_meja'><i class='ri-close-line mr-0'></i></a>
                                        <a class='badge bg-info mr-2' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit'
                                            href='edit-table.php?id_meja=$t->id_meja'><i class='ri-pencil-line mr-0'></i></a>
                                        <a class='badge bg-warning mr-2' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'
                                            href='delete-table-proses.php?delete=$t->id_meja'><i class='ri-delete-bin-line mr-0'></i></a>
                                    </div>
                                 </td>
                                </tr>
                                ";
