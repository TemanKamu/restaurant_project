...
require '../Connection.php';
	...
	*berdasarkan id
	*/
	$query = "SELECT * from tb_meja WHERE id_meja=?";
	$data = $connect->prepare($query);

	$data->bindParam(1,$_GET["id_meja"]);
	$data->execute();
	// Tampilkan datanya
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="edit-table-proses.php" method="POST" data-toggle="validator">
                            <div class="row">
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <input type="hidden" name="id_meja" value="<?= $tampil->id_meja ?>">
                                        <label>Nomor meja</label>
                                        <input type="text" class="form-control" placeholder="Enter Nomor meja" name="meja_no" value="<?=$tampil->no ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Jumlah orang" name="pax" value="<?=$tampil->jumlah_orang ?>" >
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                
                            </div>                            
                            <button type="submit" name="edit" class="btn btn-primary mr-2">Edit Meja</button>
