        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <a href="add-menu.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Menu</a>
                </div>
            </div>
            <div class="col-lg-12">
                            ...
                            foreach($tampil as $t) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='d-flex align-items-center'>
                                            <img src='$t->picture' class='img-fluid rounded avatar-50 mr-3' alt='image'>
                                            <div>
                                                $t->nama
                                ...
                                <div class='d-flex align-items-center list-action'>
                                    <a class='badge bg-success mr-2'data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit'
                                        href='edit-menu.php?id=$t->id'><i class='ri-pencil-line mr-0'></i></a>
                                    <a class='badge bg-warning mr-2' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete' href='hapus-menu.php?remove=$t->id' onclick='return confirm('Hapus menu?')'
